//----------------------------------------------------------------------------------------
// File: crea.controller.js
//
// Desc: Controller della creazione/modifica del "Controllo di gestione"
...
define([
	...
	function saveData(params) {
		...
		var sName   = (btn === 'btn-importDP')? 'cdgCrea' : 'cdgModifica';								// Nome del servizio da invocare (crea o modifica)
